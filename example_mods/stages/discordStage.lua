...
function onCreatePost()
    ...
    makeSpr({tag = "opponent", image = folder..(songName:lower() == "shut-up" and "chars/bspooki" or "chars/Not Pixelated"), x = xx, y = 100, cam = "camBDiscord", xSize = (songName:lower() == "shut-up" and 0.625 or 0.625)})
    loadGraphic({tag = "opponent", image = folder..(songName == 'nothing' and 'chars/...' or 'chars/uwenalil')})

    makeText({tag = "playerText", text = "...", cam = "camBDiscord", width = tw})
    makeSpr({tag = "player", image = folder..(songName:lower() == "shut-up" and "chars/Not Pixelated" or "chars/Annoying User"), x = xx, y = 300, cam = "camBDiscord", xSize = 0.625})
