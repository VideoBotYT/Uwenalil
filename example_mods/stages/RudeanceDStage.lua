...
function onCreatePost()
    ...
    if songName:lower() == "rudeance" then
        precacheImage(folder.."discord/ChannelsList-Light")
        precacheImage(folder.."discord/MembersListBG-Light")
        precacheImage(folder.."discord/messageBar-Light")
        precacheImage(folder.."discord/topBar-Light")
    end
    ...
    makeSpr({tag = "opponent", image = folder..(songName == "chars/..." or "chars/pixelatedammar"), x = xx, y = 100, cam = "camBDiscord", xSize = (songName:lower() == "shut-up" and 0.625 or 0.625)})

    makeText({tag = "playerText", text = "...", cam = "camBDiscord", width = tw})
    makeSpr({tag = "player", image = folder..(songName == "chars/..." or "chars/uwenalilspooki"), x = xx, y = 300, cam = "camBDiscord", xSize = 0.625})
...
function setupMembers()
    local members = {"Ammar", "Annoyer", "Bspooki", "NotAlpha", "Pixelated", "Uwenalil"}
    ...
    if string.gsub(songName:lower(), " ", "-") == "rudeance" then
        setProperty("memberList", {"Ammar", "Annoyer", "Bspooki", "NotAlpha", "Pixelated", "Uwenalil"})
    else
