...
function onCreatePost()
    ...
    if songName:lower() == "nothing" then
    ...
    makeSpr({tag = "opponent", image = folder..(songName == "chars/..." or "chars/uwenalil"), x = xx, y = 100, cam = "camBDiscord", xSize = (songName:lower() == "shut-up" and 0.625 or 0.625)})

    makeText({tag = "playerText", text = "...", cam = "camBDiscord", width = tw})
    makeSpr({tag = "player", image = folder..(songName == "chars/..." or "chars/Not Pixelated"), x = xx, y = 300, cam = "camBDiscord", xSize = 0.625})
...
function setupMembers()
    ...
    if string.gsub(songName:lower(), " ", "-") == "nothing" then
