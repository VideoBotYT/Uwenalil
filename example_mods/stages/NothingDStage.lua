...
function onCreatePost()
    ...
    makeSpr({
        tag = "opponent",
        image = folder .. (songName == "chars/..." or "chars/uwenalil"),
        x = xx,
        y = 100,
        cam = "camBDiscord",
    ...
    makeSpr({
        tag = "player",
        image = folder .. (songName == "chars/..." or "chars/Not Pixelated"),
        x = xx,
        y = 300,
        cam = "camBDiscord",
        xSize = 0.625
    ...
    if getDataFromSave("ammarc", "shaders") and getDataFromSave("ammarc", "mechanicOption") and
        getPropertyFromClass("ClientPrefs", "shaders") then
