...
local cams = {
	...
	discord = tableCopy(templateCam),
	bdiscord = tableCopy(templateCam)
}
...
function initializeCams()
	...
	cam(cams.discord, "camDiscord")
	cam(cams.bdiscord, "camBDiscord")
...
function updateCamsEarly(dt)
	if (not dead()) then
		...
		updateCamEarly(cams.discord, dt)
		updateCamEarly(cams.bdiscord, dt)
	end
...
function updateCams(dt)
	if (not dead()) then
		...
		updateCam(cams.discord, dt)
		updateCam(cams.bdiscord, dt)
	end
